...
cdef PricingSolver get_py_pricing_solver(GCG_SOLVER* pricingSolver) with gil:
...
cdef SCIP_RETCODE PyPricingSolverFree (GCG* gcg, GCG_SOLVER* solver) with gil:
...
cdef SCIP_RETCODE PyPricingSolverInit (GCG* gcg, GCG_SOLVER* solver) with gil:
    py_pricing_solver = get_py_pricing_solver(solver)
    py_pricing_solver.initSolver()
    return SCIP_OKAY


cdef SCIP_RETCODE PyPricingSolverExit (GCG* gcg, GCG_SOLVER* solver) with gil:
    py_pricing_solver = get_py_pricing_solver(solver)
    py_pricing_solver.exitSolver()
    return SCIP_OKAY


cdef SCIP_RETCODE PyPricingSolverInitSol (GCG* gcg, GCG_SOLVER* solver) with gil:
    py_pricing_solver = get_py_pricing_solver(solver)
    py_pricing_solver.initSolution()
    return SCIP_OKAY


cdef SCIP_RETCODE PyPricingSolverExitSol (GCG* gcg, GCG_SOLVER* solver) with gil:
    py_pricing_solver = get_py_pricing_solver(solver)
    py_pricing_solver.exitSolution()
    return SCIP_OKAY


cdef SCIP_RETCODE PyPricingSolverUpdate (GCG* gcg, SCIP* pricingprob, GCG_SOLVER* solver, int probnr, SCIP_Bool varobjschanged, SCIP_Bool varbndschanged, SCIP_Bool consschanged) with gil:
    py_pricing_solver = get_py_pricing_solver(solver)
...
cdef SCIP_RETCODE PyPricingSolverSolve (GCG* gcg, SCIP* pricingprob, GCG_SOLVER* solver, int probnr, SCIP_Real dualsolconv, SCIP_Real* lowerbound, GCG_PRICINGSTATUS* status) with gil:
    py_pricing_solver = get_py_pricing_solver(solver)
    py_pricingprob = GCGPricingModel.create(pricingprob)
...
cdef SCIP_RETCODE PyPricingSolverSolveHeur (GCG* gcg, SCIP* pricingprob, GCG_SOLVER* solver, int probnr, SCIP_Real dualsolconv, SCIP_Real* lowerbound, GCG_PRICINGSTATUS* status) with gil:
    py_pricing_solver = get_py_pricing_solver(solver)
    py_pricingprob = GCGPricingModel.create(pricingprob)
