...
cdef SCIP_RETCODE PyScoreFree(GCG* gcg, GCG_SCORE* score) with gil:
...
cdef SCIP_RETCODE PyScoreCalculate(GCG* gcg, GCG_SCORE* score, int partialdecid, SCIP_Real* scorevalue) with gil:
    cdef GCG_SCOREDATA* scoredata
    scoredata = GCGscoreGetData(score)
    py_score = <Score>scoredata
